...
namespace OpenXml.PowerTools.Commands
{
    ...
    public class RemoveOpenXmlPersonalInformationCmdlet : OpenXmlCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                foreach (var document in AllDocuments("Remove-OpenXmlPersonalInformationCmdlet", FileAccess.ReadWrite))
                {
                    try
                    {
                        document.Document.RemovePersonalInformation();
                        document.FlushParts();
                        if (passThru)
